...
import com.example.bettermart.data.KitchenwareViewModel
import com.example.bettermart.models.Kitchenware
...
fun ViewkitchenwareScreen(navController: NavController) {
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        var productRepository = KitchenwareViewModel(navController, context)


        val emptyProductState = remember { mutableStateOf(Kitchenware("","","","","","")) }
        var emptyProductsListState = remember { mutableStateListOf<Kitchenware>() }
...
fun ProductItem(
    ...
    navController: NavController,
    productRepository:KitchenwareViewModel, productImage:String) {
...
fun ViewkitchenwareScreenPreview(){
    ...
    ViewkitchenwareScreen(navController = rememberNavController())}
