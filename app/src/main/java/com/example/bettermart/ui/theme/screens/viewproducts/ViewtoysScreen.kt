...
import com.example.bettermart.models.Toys
import com.example.bettermart.navigation.ADD_TOYS_URL

@OptIn(ExperimentalMaterial3Api::class)
@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun ViewtoysScreen(navController: NavController) {
    Column(modifier = Modifier.fillMaxSize()) {

        var context = LocalContext.current
        var productRepository = ToysViewModel(navController, context)


        val emptyProductState = remember { mutableStateOf(Toys("","","","","","")) }
        var emptyProductsListState = remember { mutableStateListOf<Toys>() }
...
fun ProductItem(
    ...
    navController: NavController,
    productRepository:ToysViewModel, productImage:String) {
...
fun ViewtoysScreenPreview(){

    ViewtoysScreen(navController = rememberNavController())}
