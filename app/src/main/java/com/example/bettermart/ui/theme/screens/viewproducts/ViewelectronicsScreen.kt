...
import com.example.bettermart.models.Electronics
import com.example.bettermart.navigation.ADD_ELECTRONICS_URL

@OptIn(ExperimentalMaterial3Api::class)
@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun ViewelectronicsScreen(navController: NavController) {
    Column(modifier = Modifier.fillMaxSize()) {

        var context = LocalContext.current
        var productRepository = ElectronicsViewModel(navController, context)


        val emptyProductState = remember { mutableStateOf(Electronics("","","","","","")) }
        var emptyProductsListState = remember { mutableStateListOf<Electronics>() }
...
fun ProductItem(
    ...
    navController: NavController,
    productRepository:ElectronicsViewModel, productImage:String) {
...
fun ViewelectronicsScreenPreview(){

    ViewelectronicsScreen(navController = rememberNavController())}
