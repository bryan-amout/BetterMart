...
class KitchenwareViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Kitchenware(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Kitchenware>,
        products: SnapshotStateList<Kitchenware>
    ): SnapshotStateList<Kitchenware> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Kitchenware::class.java)
