...
class StationeryViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Stationery(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Stationery>,
        products: SnapshotStateList<Stationery>
    ): SnapshotStateList<Stationery> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Stationery::class.java)
