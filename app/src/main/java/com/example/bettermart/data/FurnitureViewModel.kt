...
class FurnitureViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Furniture(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Furniture>,
        products: SnapshotStateList<Furniture>
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Furniture::class.java)
