...
class ElectronicsViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Electronics(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Electronics>,
        products: SnapshotStateList<Electronics>
    ): SnapshotStateList<Electronics> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Electronics::class.java)
