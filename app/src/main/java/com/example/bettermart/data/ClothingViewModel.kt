...
class ClothingViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Clothing(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Clothing>,
        products: SnapshotStateList<Clothing>
    ): SnapshotStateList<Clothing> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Clothing::class.java)
