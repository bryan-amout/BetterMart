...
class ToysViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Toys(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Toys>,
        products: SnapshotStateList<Toys>
    ): SnapshotStateList<Toys> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Toys::class.java)
