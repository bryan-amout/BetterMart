...
class PersonaleffectsViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Personaleffects(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Personaleffects>,
        products: SnapshotStateList<Personaleffects>
    ): SnapshotStateList<Personaleffects> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Personaleffects::class.java)
