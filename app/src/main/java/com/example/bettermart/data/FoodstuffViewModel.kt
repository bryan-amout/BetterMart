...
class FoodstuffViewModel (var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Foodstuff(name,quantity,price,phone,imageUrl,productId)
    ...
    fun allProducts(
        product: MutableState<Foodstuff>,
        products: SnapshotStateList<Foodstuff>
    ): SnapshotStateList<Foodstuff> {
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Foodstuff::class.java)
